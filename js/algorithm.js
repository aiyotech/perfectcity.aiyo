...
function process( sliderValues , aboutYou ){
	...
	userInformation['TRANSIT_SCORE'] = sliderValues.transit / 100.0 || 0;
	userInformation['CRIME'] = ( 1 - ( sliderValues.crime / 100.0 ) ) || 0;
	userInformation['OUTDOOR'] = sliderValues.outdoor / 100.0 || 0;
